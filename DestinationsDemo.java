...
class Destinations {
	...
	public void printDestination() {
		System.out.println("Destinations is " + name + " in " + location + " and Package Details:");
		System.out.println("   HOTEL" + " PACKAGE COST" + " DAYS");
		System.out.println("---------------------------------");
		for (int i = 0; i < hotels.length; i++) {
			System.out.println(i + 1 + ". " + hotels[i] + " - " + packageCost[i] + " - " + noOfDays[i] + " days");
		}
